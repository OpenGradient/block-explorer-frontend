      ...
      >
        ...
        >
          ...
          <Box
            width="32px"
            height="32px"
            bg={{ _light: 'rgba(0, 0, 0, 0.06)', _dark: 'rgba(64, 209, 219, 0.15)' }}
            borderRadius="4px"
            position="relative"
            overflow="hidden"
          >
            ...
            <Box
              ...
              opacity={ 0.3 }
              backgroundImage={{
                _light: 'repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(0, 0, 0, 0.1) 3px, rgba(0, 0, 0, 0.1) 4px)',
                _dark: 'repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(64, 209, 219, 0.2) 3px, rgba(64, 209, 219, 0.2) 4px)',
              }}
            />
